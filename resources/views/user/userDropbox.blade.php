...
<body>
  ...
  <div class="site-wrap">
      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2" data-aos="fade-down">
            <h1 class="mb-0"><a href="index.html" class="text h2 mb-0">Dropbox for {{ Auth::user()->name }}</a></h1>
          </div>
    ...
    <div class="container-fluid" style="padding-bottom: 2rem!important;">
  ...
  <div class="container-fluid" data-aos="fade" data-aos-delay="500">
    <div class="swiper-container images-carousel">
      @if(Auth::user()->has_dropboxGallery =='1')
            ...
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  ...
                  <a href="{{ route('gallery.showDropbox', $item->gallery)}}" class="btn btn-outline-white py-2 px-4">See Gallery</a>
                </div>
        ...
        @elseif(Auth::user()->has_dropboxGallery =='0')
        <div class="swiper-wrapper">
          <a data-toggle="modal" data-target=".bs-example-modal-center" style="cursor: pointer;">
            <div class="swiper-slide">
              <div class="image-wrap" style="border: 2px solid white;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Create New Dropbox Gallery</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <div class="m-b-30">
                    <form method="POST" action="{{ route('uploadDropbox.store') }}">
                        @csrf
